namespace JsonTestAdapter.Helpers
{
    ...
    public class JsonTestContainer : ITestContainer
    {
        private ITestContainerDiscoverer discoverer;
        public JsonTestContainer(ITestContainerDiscoverer discoverer, string source, Uri executorUri)
        ...
        private JsonTestContainer(JsonTestContainer copy)
        ...
        public ITestContainerDiscoverer Discoverer { get { return this.discoverer; } }

        public int CompareTo(ITestContainer other)
        {
            var testContainer = other as JsonTestContainer;
        ...
        {
            return new JsonTestContainer(this);
        }
    }
}
